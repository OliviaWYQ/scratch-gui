...
class Scratch3LooksBlocks {
    ...
    laugh (args, util) {
        //new
        this._updateBubble(util.target, 'laugh', String(args.MESSAGE).substr(0, Scratch3LooksBlocks.SAY_BUBBLE_LIMIT));
    }
    ...
    hide (args, util) {
        ...
        //wait
        const duration = Math.max(0, 1000 * 0.2);
        return new Promise(resolve => {
            setTimeout(() => {
                resolve();
            }, duration);
